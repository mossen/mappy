/*
 * geoJson data to be imported
 * in real word it should be loaded by API
 */
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Alterations at the existing Castlereagh Boutique Hotel & NSW Masonic Club including repair of existing corroded external windows & installation of a double glazed window system.",
          Notes: "DEVELOPMENT APPROVAL (CONDITIONAL)",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Type:
            "BOUTIQUE HOTEL - 5 storey - conversion from heritage warehouse",
          Address:
            "53-55 Liverpool St (Lot 1 DP60150, Lot 1 DP61203 & Lot 1 DP61794)",
          Suburb: "SYDNEY",
          State: "New South Wales",
          Stage: "DA Pending",
          Category: "HOSPITALITY",
          ...
          Ownership: "PRIVATE",
          Description:
            "Proposed conversion of an existing heritage warehouse into a 5 storey boutique hotel with 115 rooms. A new hotel entrance on Douglass Street. Ground floor restaurant & lobby bar. Single basement floor accommodating services, amenities, hotel managers office, bicycle parking & end of trip facilities. Heritage restoration & public domain works. Extension/augmentation of infrastructure & services as required. Aluminium framed sliding door & clear glass.",
          Notes: "DEVELOPMENT APPLICATION SUBMITTED",
          "Additional Details":
            "Development Application Number D/2019/379. Construction timeframe is a research estimate only & subject to council approvals & other factors. Lot 1 DP63036 & Lot 1 DP63289.",
          Lat: -33.876558,
          Long: 151.204982
        },
        color: "#E9DF00"
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Alterations at the existing Ibis Sydney hotel. Recladding of the external eastern, western & southern facades from the existing flammable aluminium composite panels to less flammable solid aluminium panels.",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          "Additional Details":
            "Please note Tenderers require their prices two or more days before the tender closing date; later submissions will not be considered",
          Lat: -33.875113,
          Long: 151.208666
        },
        color: "#ECAF2D"
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Conversion & fitout of the existing basement & ground level storage & back of house area into a retail area for Louis Vuitton Sydney. New internal stairs from ground to basement level. Relocate existing drainage pipes to the eastern & northern portions of the site.",
          Notes:
            "DEVELOPMENT APPROVAL (CONDITIONAL) CONSTRUCTION NOT YET COMMENCED",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "STATE",
          Description:
            "Fit out of 1,900sqm in Level 19 Tower 2, Darling Park. The fit out will comprise: meeting rooms & collaboration spaces, sit to stand work zones & a large breakout area",
          Notes:
            "CONTRACT LET  CONTRACTOR NAMED  WORK IN PROGRESS (CNTR0010471)",
          "Additional Details":
            "RESTRICTED TENDER. Please note Tenderers require their prices two or more days before the tender closing date; later submissions will not be considered",
          Lat: -33.872068,
          Long: 151.203425
        },
        color: "#ECAF2D"
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Type: "OFFICE - fitout",
          Address:
            "350 George St (Lot 1 DP1161992 & Lots 1-10 & 14-16 SP86960)",
          Suburb: "SYDNEY",
          State: "New South Wales",
          Stage: "DA Approved",
          Category: "COMMERCIAL PREMISES",
          ...
          Ownership: "PRIVATE",
          Description:
            "Fitout & use of the existing Suite G.01 into an office for Invisalign Consultations. Installation of new graphics to existing signage structures including 1 horizontally projecting lightbox & illuminated top hamper signage.",
          Notes: "DEVELOPMENT APPROVAL (CONDITIONAL)",
          "Additional Details":
            "Development Application Number D/2018/1620. Lots 58-64 & 66-81 SP88234, Lots 83-87, 89-94 & 96-97 SP88876, Lots 99-111 SP91191, Lots 113 SP91848, Lots 121-125 SP96282 & Lots 114-119 SP92571.",
          Lat: -33.866946,
          Long: 151.207419
        },
        color: "#26A31B"
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Proposed construction of a mezzanine level retail tenancy (75sq m) at the existing Landmark Building.",
          Notes:
            "DEVELOPMENT APPLICATION REFUSED  NEW DEVELOPMENT APPLICATION NOT YET SUBMITTED",
          "Additional Details":
            "Development Application Number D/2018/1274. Lot 103 DP1010007 & Lots 1-7 SP62101.",
          Lat: -33.867935,
          Long: 151.206718
        },
        color: "#AC5A5A"
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Internal alterations on Level 17 at the existing 580 George Street.",
          Notes: "DEVELOPMENT APPROVAL (CONDITIONAL)",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "STATE",
          Description:
            "Replacement the existing 02-MCC-01 & removal of the existing switchboard o2-MCC-01.2.",
          Notes:
            "OPEN TENDERS CLOSED  CONTRACT AWARD DETAILS NOT YET AVAILABLE  (SOH-973)",
          "Additional Details":
            "Documentation available from www.tenders.nsw.gov.au. Enquiries to Amin Saskai on 02 9250 7717 or buldingtenders@sydneyoperahouse.com.",
          Lat: -33.868851,
          Long: 151.209332
        },
        color: "#26A31B"
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Fitout & use of Level 6 of the existing commercial building for a new office. Removal of existing partitions, workstations & meeting rooms & inter tenancy stairs. Demolition of kitchen. Erection of new partition walls to create 3 commercial suites (Suites 06.01, 06.02 & 06.03). New workstations. Installation of a new kitchen & breakout area.",
          Notes: "DEVELOPMENT APPROVAL (CONDITIONAL)",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Fitout of the office space on Level 3 of the existing commercial building. Demolition of partition walls & ceilings. New partition walls to boardroom, office, kitchenette & storage, new joinery for office & update finishes in the bathroom.",
          Notes: "CONSTRUCTION COMPLETE",
          "Additional Details":
            "Development Application Number D/2018/1245. Lot 8 DP63928 & Lot 9 DP63218.",
          Lat: -33.866322,
          Long: 151.212208
        },
        color: "#ECAF2D"
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Internal alterations of an office located at Level 3 of the existing heritage building. Construction of lightweight partition walls including meeting rooms, boardroom, waiting area & finance team office.",
          Notes: "DEVELOPMENT APPROVAL (CONDITIONAL) PROJECT DEFERRED",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Title: "SOMA",
          Type:
            "HEALTH & WELLNESS CENTRE/GYMNASIUM - conversion from vancant tenancies 3 & 4",
          ...
          Ownership: "PRIVATE",
          Description:
            "Conversion of vacant Tenancies 3 & 4 on the lower ground floor of the existing building to a health & wellness centre/gymnasium to include spa, 2 saunas, 3 rooms, circuit training, studio, staff room, possible assessment room, cardio, stretching, bench & lockers, lounge, office, entry, concierge, male & female water closet & accessible water closet. Existing duct to removed, existing wall to be demolished & tensile fabric screen.",
          Notes: "DEVELOPMENT APPROVAL (CONDITIONAL)",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Upgrade to the existing building comprising Level 8 smoke exhaust, levels 9 & 10 full floor upgrade, bathrooms & lobby, Levels 14 & 19 bathroom upgrades",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Fitout of new finishes to floor, walls & ceilings. Installation of retail joinery & associated cafe/bar equipment. Installation of seating, tables & booths to accommodate up to 50 patrons.",
          Notes: "DEVELOPMENT APPROVAL (CONDITIONAL)",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Notes: "DEVELOPMENT APPROVAL (CONDITIONAL)",
          "Additional Details":
            "Development Application Number D2018/922. Construction timeframe is a research estimate only & subject to council approvals & other factors.",
          Lat: -33.866514,
          Long: 151.206922
        },
        color: "#26A31B"
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Address:
            "251-253 Elizabeth St & 238-240 Castlereagh St (Lot 1 DP55847 & Lot 1 DP187103)",
          Suburb: "SYDNEY",
          State: "New South Wales",
          Stage: "DA Approved",
          Category: "HOSPITALITY",
          ...
          Notes: "DEVELOPMENT APPROVAL (DEFERRED COMMENCEMENT)",
          "Additional Details":
            "Development Application Number D/2017/1037. Offices still being leased.",
          Lat: -33.875305,
          Long: 151.209152
        },
        color: "#26A31B"
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Fitout & use of tenancy GR09 for a new coffee shop primarily providing takeaway coffee with minor takeaway snack items on offer. A new cafe counter with food display joinery. An open back-of-house food preparation area. Joinery with in-built equipment (fridges in-built coffee machine). Storage joinery. A new secondary curved ceiling to conceal provided services. Limited patron seating (4 seats internally & 4 seats & 2 tables externally). New illuminated signage to the lessor-provided shopfront. New panels installed to lessor-provided blade signage.",
          Notes: "DEVELOPMENT APPROVAL (CONDITIONAL)",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Conversion & fitout of the existing Shop No MG23 cafe into a small bar for 84 patrons. External awning. Vinyl flooring, tiled floor, stainless steel, clear glass, timber flooring, powdercoated coatings, concrete plaster with rustic application, tick copper sheet, black mild steel sheet & rendered paint. Signage.",
          Notes: "DEVELOPMENT APPROVAL (CONDITIONAL)",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Address:
            "2-12 Carrington St (Lots 1,2 & 4 DP853331), 289-307 George St & Wynyard Pl",
          Suburb: "SYDNEY",
          State: "New South Wales",
          Stage: "DA Approved",
          Category: "COMMERCIAL PREMISES",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Internal fitout of Level 44 on the existing commercial building. Removal of existing partition walls, new internal partitions & doorways & installation of new work stations.",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Internal alterations & additions to the existing mixed use building. Level 42 - Removal of some part of redundant mechanical plant equipment. Conversion of 218sq m of part of Level 42 plant room into commercial office. Basement Level 1 - Upgrade & expansion of the existing end of journey facilities. Reduction of 14 car parking spaces to accommodate new bicycle storage area. Relocation of existing pump out room from Basement Level 1 to Basement Level 2. Basement Level 2 - Reduction of 2 car parking spaces to accommodate the relocated pump out room.",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Alterations & additions to the existing commercial building. Construction of partition walls & doors to create a secure lift lobby on levels 2-6 & 11-13. Installation of glass & plasterboard partitions & doors to form secure lobbies at lift access points to the floors which have been leased by Macquarie Group.",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Type:
            "BOUTIQUE HOTEL/RETAIL - 7 storey - conversion from warehouse building",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Notes:
            "CONTRACT LET CONTRACTOR NAMED  WORK COMMENCED LATE JUNE 2018  (RFT-10015831)",
          "Additional Details": "-",
          Lat: -33.868257,
          Long: 151.210874
        },
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Alterations & additions at the existing Sofitel Sydney Darling Harbour hotel. The fire stairs from Level 1 to ground floor to increase the population to 765. New 2 guest rooms, 1 each on Levels 4 & 4B. Level 4B to include a small outdoor swimming pool. The roof over the additions would be part concrete slab at Level 5 & will be used as terraces off rooms 5.23 & 5.24. Metal roofing.",
          Notes: "DEVELOPMENT APPROVAL (DEFERRED COMMENCEMENT)",
          "Additional Details":
            "New Development Application Number D/2019/301.",
          Lat: -33.872658,
          Long: 151.198625
        },
        color: "#26A31B"
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Address:
            "42-44 Margaret St & 2 York St (Lots 10-11 DP1086866 & SP75520)",
          Suburb: "SYDNEY",
          State: "New South Wales",
          Stage: "DA Approved",
          Category: "SOCIAL",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Fitout & use of Levels 1-6 of the existing York & George commercial building as offices. Fitout of main entry, foyer & communal spaces located on Levels 1-2 with access from George Street by existing escalators & typical floor with new glazed & solid partitions creating private & communal spaces for offices, meeting rooms, hot desks & other use.",
          Notes: "CONSTRUCTION COMPLETE BUILDER NAMED",
          "Additional Details":
            "Development Application Number D/2018/511. ARCHITECT REQUESTS ALL ENQUIRIES TO BE IN WRITING ONLY.",
          Lat: -33.869402,
          Long: 151.206481
        },
        color: "#ECAF2D"
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Notes:
            "CONTRACT LET BUILDER NAMED  CONSTRUCTION TO COMMENCE AUGUST 2018 (RFT-10015571)",
          "Additional Details": "-",
          Lat: -33.866199,
          Long: 151.20635
        },
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          "Additional Details":
            "Development Application Number D/2018/406. ARCHITECT REQUESTS ALL ENQUIRIES TO BE IN WRITING ONLY.",
          Lat: -33.866758,
          Long: 151.206527
        },
        color: "#26A31B"
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Alterations & additions to the existing commercial building. Renovation of awning addressing Pitt Street. Ground floor - Addition of foyer area, DDA end of journey facilities, internal fitout of lobby & alterations of building facade. First floor - Addition of end of journey facilities, alterations of building facade & relocation of fire services water tank from internal first floor plant room to unutilised rear light well. Provision of air-intake louvres at multiple upper levels of the built form. Glazed canopy awning, metal finish cladding & clear glazing curtain wall facade.",
          Notes:
            "UNDISCLOSED BUILDER APPOINTED  NO FURTHER INFORMATION AVAILABLE",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Type: "COMMERCIAL BUILDING - altns & addns",
          Address:
            "345-355 George St (Lot 1 DP1006536, Lots 102 & 103 DP1010007)",
          Suburb: "SYDNEY",
          State: "New South Wales",
          Stage: "DA Approved",
          Category: "COMMERCIAL PREMISES",
          ...
          Ownership: "PRIVATE",
          Description:
            "Alterations & additions of Level 16 of the existing commercial building. Works to include infill of the existing balconies with full height glazing & new void area (90sq m).",
          Notes: "DEVELOPMENT APPROVAL (CONDITIONAL)",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Fitout of a gymnasium within basement level 4 of the existing building to include workout areas, change rooms, kitchen, office & store rooms.",
          Notes: "CONSTRUCTION COMPLETED",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Fitout of the office suite on Level 37 of the existing Australia Square building to include new internal partitions & removal of some existing partitions.",
          Notes: "WORK COMPLETED",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Internal fitout of Level 5 of the existing commercial building as an office. Demolition of existing walls. Construction of partition walls, workstations, DDA toilet & services.",
          Notes: "DEVELOPMENT APPROVAL (CONDITIONAL)",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Internal alterations to the existing HCF House including the installation of a new internal lift linking from floor levels 12 to 14 & associated floor plan changes. Change of use to level 14 for use as a commercial office including construction of new wc & ambulant wc.",
          Notes: "DEVELOPMENT APPROVAL COMMENCEMENT DATE NOT YET DETERMINED",
          "Additional Details":
            "DA  D/2018/192. Lot 9 DP57481 & Lot 14 DP71362.",
          Lat: -33.870148,
          Long: 151.206562
        },
        color: "#26A31B"
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Fitout to existing office suite on Level 36 to include new internal partitions & doorways & removal of some existing partitions allowing the floor to be occupied as 5 separate tenancies.",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Fitout of the ground level tenancy of the existing club into a TAB agency for 60 patrons. Demolition of existing fitout within the tenancy. Construction of internal partitions, joinery & toilet facilities. Amendments to tenancy entry. Associated signage.",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Type:
            "EDUCATIONAL ESTABLISHMENT - levels 4-6 - conversion from an office",
          ...
          Ownership: "PRIVATE",
          Description:
            "Conversion & fitout of (Ground floor & Levels 4-6) offices of the the existing multi storey commercial building into an educational facility. Works include construction of new walls to create separate classrooms & additional accessible toilets on the ground floor.",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Alterations & additions to existing & fitout to create METRO Woolworths",
          Notes: "WORK COMPLETED",
          "Additional Details": "-",
          Lat: -33.869114,
          Long: 151.207633
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Address:
            "1 Shakespeare Pl (Lot 7028 DP1077148, Lot 1 DP51387 & Lot 11 DP1177504)",
          Suburb: "SYDNEY",
          State: "New South Wales",
          Stage: "DA Approved",
          Category: "SOCIAL",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          "Additional Details":
            "SSD 17_8876.  Lot 1 DP60293, Lot 1 DP59101, Lot 1 DP436359, Lot 1 DP62668. Associated project ID6869267 for over station design team.",
          Lat: -33.875031,
          Long: 151.208272
        },
        color: "#B3BFC5"
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Stage 1 construction comprises the learning centre, staff lounges & associated works",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Fitout works & use of existing warehouse building into a restaurant to include installation of new show kitchen, reception desk, bar, internal partitions & bench seating for 184 patrons. Associated signage.",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Fit out of ground floor, level 12 & level 19. Demolition works to level 12.",
          Notes: "WORK COMPLETED",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Alterations to the existing retail tenancy on the basement, ground & first floors including a new internal retail fitout. Construction of a lift within the ground & basement floors. Alterations to the existing shopfront, facade lighting & associated business identification signage.",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Demolition of existing buildings. Construction of a 16 storey hotel accommodating 93 hotel rooms. Hotel lobby with ancillary cafe space at ground floor. Rooftop terrace on level 18. Substation at basement level 1. Back of house areas, plant & equipment, & bicycle storage area on basement levels 2 and 3.",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Notes:
            "CONTRACT LET  CONSTRUCTION TO COMMENCE LATE MAY 2018  (RFT-10013441)",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Fitout and use of part of the ground floor level facing Sussex St as a licensed restaurant and lobby bar for 150 patrons, as part of a hotel development at the site. Fitout works include floor, wall and ceiling finishes and fixtures & varied arrangements of tables and bar stools. Installation of a bar for the service of beverages and front-of-house areas for waitstaff. Installation of toilet facilities.",
          Notes: "NO FURTHER INFORMATION AVAILABLE",
          "Additional Details":
            "Development Application Number D/2017/1009. Associated project ID2000758 for hotel development.",
          Lat: -33.867566,
          Long: 151.203204
        },
        color: "#26A31B"
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Address:
            "222 Clarence St (Lot 6 DP66544, Lot 7 DP60367, Lot 8 DP64913)",
          Suburb: "SYDNEY",
          State: "New South Wales",
          Stage: "Construction",
          Category: "COMMERCIAL PREMISES",
          ...
          Ownership: "PRIVATE",
          Description:
            "Refurbishment of the existing commercial building to include new front entry doors & sliding doors to ground floor retail/common (lobby) areas. Internal demolition works. New front ground floor window openings. Internal alterations to ground floor common (lobby) area. Painting of all window frames, down pipes & security grilles to the existing facades.",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Fitout for fist use as a restaurant and portable external bar at Tenancy C.08 for proposed maximum capacity of 240 patrons: 116 inside and 124 outside & 30 staff. Timber batten, weather blinds, concrete & timber banquette & waiter stations. New signage.",
          Notes:
            "WORK LIKELY TO COMMENCE LATE 2017  PROJECT MANAGER NOT DISCLOSED",
          "Additional Details":
            "D/2017/939. Lot 800 DP1164281. Located within the International Convention Centre Sydney.",
          Lat: -33.874546,
          Long: 151.202216
        },
        color: "#ECAF2D"
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Demolition and removal of existing terrace paving and finishes and handrails. Refurbishment to the outdoor terraces on levels 8 & 9 of the existing commercial building to be used in association with the commercial offices within the building. Works include new terrace paving & overhead canopy, repaint existing cement render wall, replacement of balustrades, flooring and doors, upgrade to existing ramp to upper terrace level & fitout of services and furnishings. Frameless glass balustrade, stainless steel post, aluminium framed bi-fold door, glazed canopy awning, steel frame.",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Fitout of commercial office space on levels 16, 17 & 20 of the 28 storey AMP Building. Works include removal of existing partition walls, wall coverings, joinery, fittings, fixtures and doors. Installation of new office fitout components.",
          Notes: "WORK COMPLETED",
          "Additional Details":
            "Development Application Number D/2017/631. Lot 1 DP1073376. Associated project ID7083221 & ID7086684 for other refurbishments.",
          Lat: -33.862105,
          Long: 151.211609
        },
        color: "#ECAF2D"
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Facades refurbishment & extension of shopfronts to the existing commercial building on George Street & York Street. Black metal cladding & stone column cladding. Associated signage.",
          Notes: "DEVELOPMENT APPROVAL  PROJECT PROCEDURE NOT YET AVAILABLE",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Conversion of existing shops 2455, 2457 & 2459 within Harbourside Shopping Centre to create barbeque restaurant for 120 patrons. Scope of works includes: installation of mechanical ventilation system & restaurant fitout. Signages.",
          Notes: "DEVELOPMENT APPROVAL",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Demolition works including the removal of existing paving, sunhoods, handrails, and balustrades on Level 1 external terrace of Tower 3. Construction of a terrace area comprising a transparent fritted glass canopy, timber decking, planter beds and installation of new glass doors and balustrades. Landscaping.",
          Notes: "CONSTRUCTION COMPLETED BY UNDISCLOSED BUILDER",
          "Additional Details":
            "Development Application Number D/2017/602. Lot 12 DP801770 & Lot 62 DP864696. Associated project ID6976678 for Level 3 terrace refurbishment.",
          Lat: -33.872068,
          Long: 151.203425
        },
        color: "#ECAF2D"
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Level 24 commercial office fitout to include removal of existing partition walls, installation of new full height partitions & doors, new loose furniture, new reflected ceiling lighting layout & new floor finishes & paint.",
          Notes: "DEVELOPMENT APPROVAL",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          "Additional Details":
            "DA D/2017/371. This project will be constructed concurrently with associated Project ID7167294",
          Lat: -33.870286,
          Long: 151.209881
        },
        color: "#ECAF2D"
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Alterations to 2 existing commercial buildings. Works include an extension of commercial office levels between levels 1-3. Addition of a terrace at level 4. Extension to the existing child care centre at 309 Kent St. Refurbishment of the plaza forecourt and retail and lobby spaces at 321 Kent St.",
          Notes: "CONSTRUCTION IN PROGRESS  BUILDER NAMED",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Fitout of commercial office space on levels 14 & 15 of the 28 storey AMP Building. Works include demolition of the existing central meeting room on both levels, creation of new meeting rooms to the boundary of the floor & new wall coverings, joinery, fittings, fixtures and doors.",
          Notes: "WORK COMPLETED",
          "Additional Details":
            "Development Application Number D/2017/242. Lot 1 DP1073376.",
          Lat: -33.862105,
          Long: 151.211609
        },
        color: "#ECAF2D"
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Alterations to the existing terrace on level 4. Works include extend existing metal roof and construct a new operable pergola and a windbreak to the existing planter box at the western perimeter of the terrace. Metal pergola, glass screen, timber decking.",
          Notes: "CONSTRUCTION COMPLETED",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          "Additional Details":
            "Development Application Number D/2017/445. Alternative address is 279 Clarence Street. Developer no longer involved",
          Lat: -33.872349,
          Long: 151.205354
        },
        color: "#26A31B"
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          "Additional Details":
            "D/2017/434. Lot 1 DP 650520, Lot 1 DP 657427, Lot 1 DP 185342, Lot 1 DP 650320. Hotel will be a Crowne Plaza branded hotel managed by Intercontinental Hotel Group. Commencement subject to completion of base building construction. Associated Projects ID1937616 & ID6883511.",
          Lat: -33.873848,
          Long: 151.204465
        },
        color: "#ECAF2D"
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Fitout & use of Tenancy G2 as a retail Vodafone shop for a maximum of 150 customers & staff. To include product display tables, meeting booths, service bars, display screens and lightboxes, an internal dynamic content signage and window signs.",
          Notes: "CONSTRUCTION COMPLETE BUILDER NAMED",
          "Additional Details":
            "Development Application Number D/2017/344. Lot 1 DP1223808.",
          Lat: -33.869402,
          Long: 151.206481
        },
        color: "#ECAF2D"
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Blanket approval for the fitout & change of use of all commercial tenancies within Levels 2 to 20 of the existing mixed use building including lift shaft extension.",
          Notes: "CONSTRUCTION IN PROGRESS",
          "Additional Details":
            "DA 2017/296. Associated project ID7069094 for podium & lobby renovation.",
          Lat: -33.868496,
          Long: 151.204148
        },
        color: "#ECAF2D"
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Notes:
            "SITE STILL FOR SALE WITH DEVELOPMENT APPROVAL EXPRESSIONS OF INTEREST CLOSED",
          "Additional Details":
            "Development Application Number D/2017/337. Construction likely to commence following the completion of the George St light rail project. Expressions of Interest close 9 August 2018 at 4:00pm.  Alternative contact McVay Real Estate Dan McVay 0412 872 859",
          Lat: -33.870148,
          Long: 151.206562
        },
        color: "#26A31B"
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "STATE",
          Description:
            "Construction and fitout of two district courts and associated services on Level 6, Downing Centre Sydney.",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Fitout within the existing Level 6 Lobby of the existing commercial building for use as a cafe with 87 seats to include construction of servery & separate kitchen.",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          "Additional Details":
            "DA 2017/188. Lot 1 DP168328 & Lot 100 DP771509.",
          Lat: -33.872068,
          Long: 151.203425
        },
        color: "#ECAF2D"
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Alteration and fitout works to the existing Transport House heritage commercial building including internal refurbishment works to the lobby and toilets on Levels 1 to 11. Detailed works are: refurbishment to the lobbies in front of the lifts on levels 2 to 11, refurbishment to the heritage toilets on levels 2 and 3 of the building, refurbishment and reconfiguration of the toilets on levels 4 to 11 of the building including the retention of the airlock vestibule.",
          Notes: "NO FURTHER INFORMATION AVAILABLE",
          "Additional Details":
            "D/2016/1804. Associated project ID6904943 for overall building renovation.",
          Lat: -33.865394,
          Long: 151.205402
        },
        color: "#26A31B"
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          "Additional Details":
            "New Development Application Number D/2018/227.",
          Lat: -33.876349,
          Long: 151.204026
        },
        color: "#26A31B"
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "STATE",
          Description:
            "Alterations works to the state library including excavation works & extension of the existing winter garden on the lower ground level of the Macquarie Building down to the third lower ground level (LG03).",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Fitout of tenancy T01 in the Sydney International Convention Centre for use as a licensed restaurant for 200 patrons including 2 levels of internal seating for 80 patrons on the ground floor & 84 patrons on the upper floor & 32sq m outdoor seating for 36 patrons. Work includes food & drinks preparation & service areas, tables & bar stools, outdoor seating, back of house facilities, sanitary facilities on both levels & commercial kitchen.",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Infill of void area to create a 64sq m function room on level 4 of the IBIS World Square Hotel for a maximum capacity of 90 persons.",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Fitout & use of tenancy T02 & T03 within the International Convention Centre building at Darling Harbour for a licenced restaurant with capacity for up to 338 seated patrons & outdoor seating for 88 patrons. Internal works include food & drinks preparation & service areas, free-standing rotisserie and pastry island counters, bar stools & a private dining area, back-of-house facilities, managers office, prep kitchen, store rooms & sanitary facilities.",
          Notes: "WORK COMPLETED",
          "Additional Details":
            "Development Application Number D/2017/1347. Lot 800 DP1164281. Located on the ground level of ICC Theatre. Project previously lodged separately & granted approval: D/2016/1580 for Sake Restaurant & D/2016/1582 for Fratelli Fresh.",
          Lat: -33.87004,
          Long: 151.197845
        },
        color: "#ECAF2D"
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "STATE",
          Description:
            "Construction & fitout of a district court & associated spaces on Level 5 of the Downing Centre",
          Notes:
            "CONTRACT LET  WORK COMMENCED EARLY JANUARY 2017 (DJ 2016 - 97)",
          "Additional Details": "RESTRICTED TENDER",
          Lat: -33.878073,
          Long: 151.208962
        },
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Change of use of an office space at ground floor, mezzanine & level 1 to a licensed food & drink premises with a patron capacity of 100 including internal fitout, installation of sanitary facilities and signage. Internal alterations include partitioning, installation of fixed & loose joinery, bar service areas, kitchen, an internal lift & internal wall, floor & ceiling finishes. \r",
          Notes: "DEVELOPMENT APPROVAL",
          "Additional Details":
            "D/2016/1466. Refer to associated project ID1991901 for the mixed use building.",
          Lat: -33.872238,
          Long: 151.205225
        },
        color: "#26A31B"
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "STATE",
          Description:
            "Structural & civil engineering services for redevelopment of the Sydney Fish Market",
          Notes:
            "CONSULTANTS APPOINTED FOR STRUCTURAL AND CIVIL ENGINEERING SERVICES  (4418/16)",
          "Additional Details":
            "Overall project ID2157667  & associated consultancy project ID7001782",
          "Completion Date": "-",
          Lat: -33.873247,
          Long: 151.202759
        },
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Notes: "CONSTRUCTION IN PROGRESS",
          "Additional Details":
            "D/2016/1478. Applicant is Maritime Nominees Pty Ltd",
          Lat: -33.863815,
          Long: 151.203521
        },
        color: "#ECAF2D"
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "LOCAL GOVT",
          Description:
            "Design & construction of Town Hall House Level 4 function/venue spaces upgrade. Scope of work includes: upgrade of lobby & circulation space; new accessible bathroom; upgrade existing bathrooms; new floor finishes; upgrade to mechanical, fire & electrical services.",
          Notes:
            "CONTRACT LET FOR DESIGN/CONSTRUCT  CONSTRUCTION TO COMMENCE MID NOVEMBER 2016  (1654)",
          "Additional Details": "-",
          Lat: -33.873198,
          Long: 151.206018
        },
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Alterations & additions to the rooftop level of an existing residential flat building including replacement of clubhouse roof, resurfacing of the existing tennis court, upgrade existing plant room, construction of a new pavilion with louvre roof & new landscaping.",
          Notes: "DEVELOPMENT APPROVAL",
          "Additional Details":
            "D/2016/1384. Applicant is The Owners Corporation.",
          Lat: -33.868969,
          Long: 151.204959
        },
        color: "#26A31B"
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          "Additional Details":
            "Council will enter into a contract, subject to the conclusion of negotiations, with suitable companies for the delivery of the Town Hall house goods lift No. 9 upgrade.",
          "Completion Date": "-",
          Lat: -33.873198,
          Long: 151.206018
        },
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Alterations to the existing Westpac bank branch including the removal & replacement of all business identification signage, the replacement of the existing ATM & internal alterations.",
          Notes: "WORK COMPLETED",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "STATE",
          Description:
            "Fit-out for the Rangers Control Room. Supply & install the temporary site office accommodation of approximately 90sq m. The temporary site office accommodation shall be pre-fabricated off site.The new temporary site office accommodation with be situated within the existing Darling Harbour Cleaner's Compound in Exhibition Place in Darling Harbour",
          Notes:
            "CONTRACT LET  CONSTRUCTION COMMENCED MID DECEMBER 2016 (SHFA-101100610)",
          "Additional Details": "-",
          Lat: -33.877396,
          Long: 151.201271
        },
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Renovation of the remainder of the Australia Square Level 4 food court including demolition works & internal fitout works of food court tenancies 402, 404, 406, 408, 413, 419, 420, 421 & 422 for upgrades to their layout, counter & kitchen areas for future internal fitout works.",
          Notes: "WORK COMPLETED",
          "Additional Details":
            "D_2015_1217. Client is Australia Square Management. Associated project ID6857237.",
          Lat: -33.864948,
          Long: 151.207955
        },
        color: "#ECAF2D"
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          "Project ID": "6976081",
          Title:
            "GALLIPOLI MEMORIAL CLUB - QUAY QUARTER SYDNEY-PROJECT INCORPORATED WITHIN ID2148497",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Address:
            "8-18 Bent St, 1 Farrer Pl & 39-47 Phillip St (Lot 104 DP836610)",
          Suburb: "SYDNEY",
          State: "New South Wales",
          Stage: "Construction",
          Category: "HOSPITALITY",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Fit out of approximately 33,600sq m in Tower 2 of Darling Park for IAG.  This will comprise Levels 1-19 inclusive.",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Fitout & use of tenancies 2-01 & 3-01 & the external terrace on level 3 of the Gateway Building as a licensed restaurant with a capacity of 250 patrons, 130 internal & 120 on the external terrace. Fitout works at 2-01 include a central bar with seating, kitchen with pizza oven, cool room, tables & chairs at the centre of the site & south eastern corner & entrance to the site. Terrace level at 3-01 includes a pergola structure, solid & operable roof over the bar, a 1.6m glass balustrade, seatings & lounges, ancillary services & new lighting features.",
          Notes: "WORK COMPLETED",
          "Additional Details":
            "D/2016/1158. Lot 53 DP 787143. Applicant is Popina Kitchen Pty Ltd.",
          "Completion Date": "-",
          Lat: -33.862027,
          Long: 151.209875
        },
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Internal & external alterations of the Paragon Hotel at ground, first floor & roof to facilitate the use of part of the first floor bar as an outdoor area with a retractable awning at Loftus Street. The capacity of the first floor is to remain at 321 patrons & ground floor at 148 patrons.",
          Notes: "CONSTRUCTION IN PROGRESS BUILDER NAMED",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Fitout and use of tenancies 7002, 7003 and 7004, adjacent outdoor terrace and internal mall seating within Westfield Sydney as a licenced hotel/restaurant & cafe with capacity for 800 patrons, including alterations to the outdoor terrace including new retractable awning and escalator enclosure.",
          Notes: "DEVELOPMENT APPROVAL  PROJECT PROCEDURE NOT YET AVAILABLE",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Type:
            "EDUCATIONAL ESTABLISHMENT - 11 level - conversion from commercial",
          Address:
            "255-269 Elizabeth St (levels ground, 1-4, 6, 8, 11, 12, 13, 15)",
          Suburb: "SYDNEY",
          State: "New South Wales",
          Stage: "Construction",
          Category: "EDUCATION",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Notes: "CONSTRUCTION COMPLETED",
          "Additional Details":
            "DA 2016/1008.  Developer trading as Tuckerbox Hotel Trust.",
          Lat: -33.878174,
          Long: 151.21082
        },
        color: "#ECAF2D"
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Address:
            "210-232 George St (Lot 21 DP1063401, Lot 1 DP75111, Lot 1 DP70970)",
          Suburb: "SYDNEY",
          State: "New South Wales",
          Stage: "Construction",
          Category: "COMMERCIAL PREMISES",
          ...
          Notes: "CONSTRUCTION IN PROGRESS",
          "Additional Details":
            "DA (Stage 2) 2017/1750 approval August 2018. Stage 1 concept DA 2016/1675 approval. Marketing Information: www.polycentre.com. Alternative contacts: Colliers International: Jock Gilchrist 0438 847 574 & Robert Gishen 0412 432 647; at JLL: Linda Ko 0411 673 384.",
          Lat: -33.870148,
          Long: 151.206562
        },
        color: "#ECAF2D"
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Alterations & additions to existing licenced restaurant. Scope of work includes: alterations to the outdoor seating area & kitchen. Installation of new outdoor canopy structure & weather protection",
          Notes:
            "DEVELOPMENT APPROVAL (CONDITIONAL) CONSTRUCTION NOT YET COMMENCED",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Potential mixed use development site which will be amalgamated with surrounding blocks to create a residential, hotel & retail precinct. Site may support a residential tower of more than 500 apartments with a height of 235m.",
          Notes: "PROJECT NOW INCLUDED IN ID1948012",
          "Additional Details":
            "Associated projects ID2020237 for 338 Pitt St & ID1948012 for 241-245 Castleregh St, 126 Elizabeth St & 342-348 Pitt St, sites now consolidated & reported as project ID1948012.",
          "Completion Date": "-",
          Lat: -33.871264,
          Long: 151.208202
        },
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Alterations to the lower ground and upper ground levels of the existing commercial building, including relocation of existing through-site link, alterations to tenancies, alterations to the Castlereagh St frontage, creation of a new cafe space. Removal of escalators.",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Address:
            "477-481 (Lot B) Kent St (DP435519) (ground, B1, B2 & levels 1-3)",
          Suburb: "SYDNEY",
          State: "New South Wales",
          Stage: "DA Approved",
          Category: "HOSPITALITY",
          ...
          Ownership: "PRIVATE",
          Description:
            "Internal alterations to existing backpacker accommodation to basement, ground floor, level 1-level 3 to provide 43 additional beds, new shower facilities and amenities and a new travel desk and job search programs. Reconfiguration of the basement communal area to the kitchen and dining.",
          Notes: "PROJECT ABANDONED",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Notes: "DEVELOPMENT APPROVAL  PROJECT DEFERRED",
          "Additional Details":
            "Development Application Number D/2017/353. Lot 1 DP103645, Lot 11 DP70261",
          Lat: -33.870148,
          Long: 151.206562
        },
        color: "#26A31B"
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Change of use of level 24 & part of level 23 of the existing Angel Place building from office premises to an educational establishment for Macquarie University for use by up to 180 students. Level 24 has a floor area of 1682sq m & level 23 has a fitout area of 1038sq m. The Applied Finance Centre & Macquarie Graduate School of Management will occupy the establishment & the Faculty of Business & Economics will utilise some of the teaching space. The work on level 23 includes 3 large & 2 small teaching rooms, a meeting room, computer lab, 2 quiet zones, 6 syndicated spaces, open meeting & collaboration space, utility & storage spaces. Level 24 work includes a reception area, small library, offices & boardroom, administration spaces, 7 meeting rooms, 4 large teaching rooms, 2 quiet zones, open meeting & collaborative space & staff breakout area. Open stair access between floors.",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "LOCAL GOVT",
          Description:
            "Facade restoration of Customs House. Conserve the sandstone facades of Customs House on all four elevations & introduce architectural facade lighting to the north facade",
          Notes:
            "HERITAGE ARCHITECT SERVICES IN PROGRESS  NO FURTHER INFORMATION AVAILABLE (1611)",
          "Completion Date": "-",
          "Additional Details": "-",
          Lat: -33.862198,
          Long: 151.210857
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Conversion of existing inaccessible external area into an accessible external terrace for use by occupants of office tenancy. Proposal includes: replacement of existing surface with granite/concrete pavoirs; installation of 1.4m high frameless glazed balustrade setback from perimeter of terrace; relocation of existing exhaust grill; infill of existing grillers & openings & facade alterations including new opening to provide direct access from Level 15.",
          Notes: "DEVELOPMENT APPROVAL  PROJECT PROCEDURE NOT YET AVAILABLE",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Notes:
            "DEVELOPMENT APPROVAL (DEFERRED COMMENCEMENT)  BUILDER NAMED  BUILDING TO BE PRE-SOLD",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Fitout & use of tenancy for cafe for 144 patrons & 20-40 staff - central coffee/drink brew bar with seating around, take away coffee window & area, kitchen, preparation & cool room, small retail area & tables & chairs at rear & on mezzanine level.",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          "Additional Details":
            "Stage 2 DA 2015/1845, Stage 1 DA 2015/1518 approved.  Lot 1DP215950, Lots 2, 3 & 4 DP217745.",
          Lat: -33.865333,
          Long: 151.207557
        },
        color: "#ECAF2D"
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "STATE",
          Description:
            "Revitalisation of Circular Quay wharf area. Proposal is to transform the rundown ferry terminal into futuristic, glass-paneled  wharves, complete with stunning outdoor restaurants & modern shopping outlets. Potential upgrades currently under consideration are making the wharves more accessible, or a complete upgrade to include double-storey wharves with new shopping facilities",
          Notes:
            "TENDERS CLOSED FROM SELECTED CONSULTANTS  2 UNDISCLOSED PARTICIPANTS HAVE BEEN SELECTED TO CONTINUE TO PHASE 2 OF STRUCTURED MARKET ENGAGEMENT (TFNSW 2016/059)",
          "Additional Details":
            "TfNSW will proceed in 2019 to Phase 2 of this market process, offering two urban renewal & infrastructure consortia the opportunity to progress and refine their ideas in a competitive process. This phase of the process is expected be finalised in the 2019/20 financial year.",
          Lat: -33.861204,
          Long: 151.210919
        },
        color: "#B3BFC5"
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Address:
            "5-11 (Lot 2) Wentworth Av (DP707511) (ground floor & level 1)",
          Suburb: "SYDNEY",
          State: "New South Wales",
          Stage: "Construction",
          Category: "HOSPITALITY",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Potential development site  Flexible zoning allowing residential/commercial/serviced apartments/hotel uses. Vacant possession can be secured in the short term. Existing improvements of 1,400sq m will provide potential for holding income\rOwner occupation, development or investment opportunity.",
          Notes: "SITE SOLD  NO FURTHER INFORMATION AVAILABLE",
          "Additional Details":
            "Alternative contacts Knight Frank John Bowie Wilson 0423 000 882 & Jonathan Vaughan 0423 681 854",
          "Completion Date": "-",
          Lat: -33.872492,
          Long: 151.205265
        },
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          "Project ID": "2160630",
          Title:
            "SICEEP BUILDING W1 WESTERN PLOT STUDENT ACCOMMODATION DARLING SQUARE",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Notes:
            "DEMOLITION STILL IN PROGRESS  CONSTRUCTION EXPECTED TO COMMENCE EARLY APRIL 2019",
          "Additional Details":
            "DA 2015/1136. Lot 1 DP87527, Lot 1 DP128971. Project designed to achieve a 5 Star Green Star Design as Built rating. Developer is 275 George Street Custodian Pty Ltd.",
          Lat: -33.865305,
          Long: 151.207051
        },
        color: "#ECAF2D"
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Address:
            "108-120 Pitt St (Tenancy 2, ground/part lower ground floor)",
          Suburb: "SYDNEY",
          State: "New South Wales",
          Stage: "Construction",
          Category: "RETAIL",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Notes:
            "SELECTED TENDERS INVITED CONTRACT AWARD DETAILS NOT YET AVAILABLE",
          "Additional Details":
            "DA 2015/1100.  Developer is Well Smart Investment Holding (Syd) Pty Ltd.",
          Lat: -33.871828,
          Long: 151.20585
        },
        color: "#26A31B"
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Notes:
            "SITE WORKS IN PROGRESS  CONSTRUCTION TO PROCEED PROGRESSIVELY",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Notes:
            "CONTRACT LET   CONSTRUCTION EXPECTED TO COMMENCE EARLY AUGUST 2016",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          "Additional Details":
            "DA 2015/334.  ARCHITECT REQUESTS NOT TO BE CONTACTED",
          "Completion Date": "-",
          Lat: -33.874708,
          Long: 151.208311
        },
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Alterations & additions to level 5 terrace of a 41 storey existing commercial building including the construction of a roof to the existing terrace area. The proposed roof structure is 17.5m x 12.7m & is not enclosed on any sides. The structure consists of glazed panels attached to steel purlins & a 5.2m timber batten screen behind the eastern side of the roof structure.",
          Notes: "DEVELOPMENT APPROVAL NO FURTHER INFORMATION AVAILABLE",
          "Additional Details":
            "DA-2014/1505. Applicant is QBE Australia & New Zealand.",
          "Completion Date": "-",
          Lat: -33.872716,
          Long: 151.207555
        },
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Construction of a freestanding McDonald's including McCafe & party room, with a total GFA 483sq m. Dining seating of 98 seats, 74 internal & 24 terrace. Brick veneer, timber & aluminium walls, metal roof, concrete floor & steel frame. Dual lane drive-thru, 2 waiting bays & a loading bay. Carparking for 37 cars including 1 accessible space. Landscaping",
          Notes: "CONSTRUCTION COMPLETED",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Notes:
            "DEVELOPMENT APPLICATION EXPECTED TO BE SUBMITTED SECOND HALF 2019",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Proposed concept development application for the construction of a 35 storey mixed use building to comprise apartments on Levels 7-34, retail space on the lower & ground floor (1023sq m) & commercial on Levels 1-5 (8553sq m) in Stage 1. Associated 3 levels of basement car parking landscaping.",
          Notes: "CONCEPT DEVELOPMENT APPLICATION SUBMITTED",
          "Additional Details":
            "Development Application Number D/2019/992. Construction timeframe is a research estimate only & subject to council approvals & other factors. ARCHITECT REQUESTS ALL ENQUIRIES TO BE IN WRITING ONLY.",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Proposed construction of 67-storey mixed use development site.  Four basement levels for parking, storage and services, retail uses at ground and level 1, hotel use of the Castlereagh Street podium at levels 2 to 10, commercial uses in the Pitt Street podium at levels 1 to 4, and residential uses in a tower from levels 6 to 66 above.",
          Notes: "PROJECT NOW INCLUDED IN ID1948012",
          "Additional Details":
            "Associated projects ID6872251 for 332 Pitt St & ID1948012 for 241-245 Castleregh St, 126 Elizabeth St & 342-348 Pitt St, sites now consolidated & reported as project ID1948012.",
          "Completion Date": "-",
          Lat: -33.876397,
          Long: 151.208098
        },
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Address:
            "420-424 Kent St & 275-277 Clarence St (Lot 1 DP782342 & Lot 20 DP64289)",
          Suburb: "SYDNEY",
          State: "New South Wales",
          Stage: "DA Pending",
          Category: "HOSPITALITY",
          ...
          Notes:
            "NEW DEVELOPMENT APPLICATION SUBMITTED  AWAITING COUNCIL DECISION",
          "Additional Details":
            "New Development Application Number D/2018/1577. Construction timeframe is a research estimate only & subject to council approvals & other factors. Lot 1 DP74422, Lot 2-8 SP17931 & Lot 9 SP20546.",
          Lat: -33.872238,
          Long: 151.205225
        },
        color: "#E9DF00"
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Type:
            "RETAIL/COMMERCIAL/RESTAURANT - 6 storey - altns & addns to former club",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          "Additional Details":
            "DA 2014/1307.  Lot C DP66537 and Lot 1 DP 206548.  ARCHITECT REQUESTS NOT TO BE CONTACTED",
          Lat: -33.872068,
          Long: 151.203425
        },
        color: "#ECAF2D"
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          "Additional Details":
            "Stage 2 DA 2016/1160. Lot 2 DP547423.  Marketing Information: www.kingandphillip.com.au or 1800 200 877.",
          Lat: -33.869021,
          Long: 151.210782
        },
        color: "#ECAF2D"
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Notes:
            "DEVELOPMENT APPROVAL BY LAND & ENVIRONMENT COURT (CONDITIONAL) WORKING DRAWINGS NOT YET COMMENCED",
          "Additional Details":
            "New Development Application Number D/2017/1720.",
          Lat: -33.878949,
          Long: 151.20978
        },
        color: "#26A31B"
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Notes:
            "DEVELOPMENT APPROVAL  PROJECT DEFERRED UNTIL LATE 2019 DEMOLITION NOT YET COMMENCED",
          "Additional Details":
            "DA 2014/764. Lot 1 DP 907270, Lot 1 DP60489.  ARCHITECT REQUESTS NOT TO BE CONTACTED",
          Lat: -33.876096,
          Long: 151.209055
        },
        color: "#26A31B"
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Notes: "CONSTRUCTION IN PROGRESS",
          "Additional Details":
            "DA 2015/1700.  Lot 1 DP650520, Lot 1 DP657427, Lot 1 DP185342, Lot 1 DP650320. Associated projects: ID6883511 for demolition & bulk excavation & ID7077996 for fitout of hotel. Marketing Information: www.60bathurst.com.au or 1800 852 088. Display Suite at 321 Sussex St, Sydney open 7 days 11.00am-4.00pm (CBRE)",
          Lat: -33.873848,
          Long: 151.204465
        },
        color: "#ECAF2D"
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Notes:
            "SITE SOLD WITH DEVELOPMENT APPROVAL TO UNDISCLOSED DEVELOPER  CONSTRUCTION STILL NOT YET COMMENCED",
          "Additional Details":
            "DA 2014/1323.  Lot 2 DP214122, Lot 1 DP104452, Lot 4 DP510295",
          Lat: -33.877665,
          Long: 151.210858
        },
        color: "#26A31B"
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Notes:
            "SITE WORKS IN PROGRESS  CONSTRUCTION NOT YET COMMENCED PROJECT MANAGER NAMED",
          "Additional Details":
            "DA - D/2014/797. Alternative address City of Sydney, 116 Bathurst St, Sydney (Lot 1 DP1193135). MGallery by Sofitel. Owner United Development Sydney (UDS). Marketing Information: www.castleresidences.com.au or 1800 775 685. Display Suite at Level 11, 201 Elizabeth St, Sydney.",
          Lat: -33.873022,
          Long: 151.209048
        },
        color: "#ECAF2D"
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Notes:
            "AMENDED DEVELOPMENT APPROVAL APPLICATION SUBMITTED AWAITING COUNCIL DECISION",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Title: "SUSSEX ST MIXED DEVELOPMENT",
          Type:
            "HOTEL SUITES (202)/APARTMENTS (102)/RETAIL/COMMERCIAL - 32 storey",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          "Additional Details":
            "DA 2014/2013. Associated project ID1969436 for display suite. Chinese developer Aoyuan Property has partnered with Ecove as joint venture partner for the development.",
          Lat: -33.877146,
          Long: 151.20969
        },
        color: "#ECAF2D"
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          "Additional Details":
            "SSD 16_7484.  Lot 1877 DP8770000, Lot 56 DP729620.  Developer trading as Tristar Sandstone Pty Ltd. Associated project ID7020334 for public domain works.",
          Lat: -33.863509,
          Long: 151.210185
        },
        color: "#ECAF2D"
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Installation of a temporary, tensile fabric pavilion structure on a floating pontoon within Cockle Bay, measuring 90m x 26.9m; anchoring of the pontoon to the foreshore & seabed in the south-west corner of Cockle Bay; construction of pedestrian gangways; installation of lighting & services; fitout & use of the structure for approximately 3 years. Eastern part of the pontoon will be used as a terrace area, with perimeter balustrade. The pavilion will have a steel frame structure supporting a roof constructed of ETFE - ethylene tetrafluoroethylene fabric, sides will be enclosed with ETFE panels.",
          Notes: "CONSTRUCTION COMPLETED",
          "Additional Details":
            "DA 2013/1469.  Structural engineering drawings for pontoon by Hawthorn Geddes EnginEers Architects Ltd, 7 Selwyn Av, Whangarei Ph: 09 438 7139 Fax: 09 430 01711 email: hg@hgcs.co.nz",
          Lat: -33.86907,
          Long: 151.201617
        },
        color: "#ECAF2D"
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Removal of existing defective windows & glazed doors above the podium with the exception of the Pitt Street facade between level 6 and level 9; replacement of existing window/door glazing and framing, upgrade of facade & replacement of the balustrade system. Window Glazing: Viridian ComfortPlus Clear 82 6.38mm, window frames: anodised aluminium frames, balustrade: clear glazing, balustrade framing: anodised aluminium frames.",
          Notes: "NO FURTHER INFORMATION AVAILABLE",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Notes:
            "CONSTRUCTION IN PROGRESS  CONSTRUCTION EXPECTED TO BE COMPLETED FEBRUARY 2020",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Notes: "CONSTRUCTION IN PROGRESS",
          "Additional Details":
            "SSD 15_7388.  Lots 401, 402, 403, 404 and 405 DP 862501.",
          Lat: -33.873578,
          Long: 151.201565
        },
        color: "#ECAF2D"
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Notes:
            "STAGE 1 DEVELOPMENT APPROVAL (DEFERRED COMMENCEMENT)  NEW OWNERS NAMED",
          "Additional Details":
            "DA 2010/1533 for Stage 1 building envelope only, Stage 2 DA subject to confidential design competition. Project aiming for a 6 Star Green Star rating.",
          Lat: -33.862082,
          Long: 151.208812
        },
        color: "#26A31B"
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Notes:
            "DEVELOPMENT APPROVAL BY LAND & ENVIRONMENT COURT  PROJECT PROCEDURE NOT YET DETERMINED",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Construction of a 26 storey hotel with ground floor hotel lobby, podium uses including hotel facilities & terraces, 23 storeys of hotel rooms (comprising a total of 348 rooms), & rooftop bar & outdoor landscaped rooftop terrace. One level of plant services, hotel back of house & loading dock at Lower Ground Level. 4 basement levels including 70 car parking spaces with vehicle access from Erskine Street.",
          Notes: "PROJECT NOT EXPECTED TO PROCEED UNTIL 2022",
          "Additional Details":
            "SSD 18_9694  DA 2008/1948 Stage 1 approval for building envelope.   Lots 1 3 DP443974, Lot 1 DP76374, Lot 1 DP 980369 & Lot 305 DP669166.\r",
          Lat: -33.867009,
          Long: 151.204732
        },
        color: "#B3BFC5"
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Notes: "CONSTRUCTION IN PROGRESS",
          "Additional Details":
            "DA 2013/1822. Associated projects ID1023783 & 1795332.",
          Lat: -33.874883,
          Long: 151.207605
        },
        color: "#ECAF2D"
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Alterations to commercial office building including the installation of a new air conditioning system to Levels 1 to 5 with associated roof units.",
          Notes: "DEVELOPMENT APPLICATION SUBMITTED",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Retail fitout of tenancies 10-12 for use by Longines of Queen Victoria Building. Installation of a point of sale counter, display journey & single work room/storage room with access door. Suspended plasterboard ceiling & tiled floor finish. Associated signage.",
          Notes: "DEVELOPMENT APPROVAL",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Internal fitout of Suite 2, Level 21 on the existing commercial building.Removal of existing partition walls & installation of new plasterboard walls, glazed walls & doors.",
          Notes: "DEVELOPMENT APPROVAL (CONDITIONAL)",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Internal alterations to levels 1-3 of the existing building for an office fitout.",
          Notes: "DEVELOPMENT APPROVAL (CONDITIONAL)",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Internal fitout of the ground floor shop of the existing hotel. New shop front & signage on the ground floor facade.",
          Notes: "DEVELOPMENT APPROVAL (CONDITIONAL)",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Base building refurbishment to Ground Floor, Levels 10 to 18 (bathrooms, lobbies, corridor) and essential services upgrade",
          Notes: "SELECTED TENDERS INVITED TENDERERS NAMED",
          "Additional Details":
            "Please note Tenderers require their prices two or more days before the tender closing date; later submissions will not be considered",
          Lat: -33.86585,
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Notes:
            "STAGE 1 DEVELOPMENT APPLICATION EXPECTED TO BE SUBMITTED 2019",
          "Additional Details": "-",
          Lat: -33.870148,
          Long: 151.206562
        },
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          "Additional Details":
            "Documentation available from www.hpw.qld.gov.au/qtenders.",
          Lat: -33.871474,
          Long: 151.205164
        },
        color: "#26A31B"
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Office fitout of the entire Level 11 floor at the existing AWA Tower. Removal of some partitions, doors, furniture & fixtures. Installation of new glass & plasterboard partitioning walls. Partial installation of plasterboard ceiling & acoustic ceiling tiles.",
          Notes: "DEVELOPMENT APPROVAL (CONDITIONAL)",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Upgrade to Tas & Food Technology rooms at St Mary's Cathedral College.",
          Notes: "SELECTED TENDERS INVITED TENDERERS NAMED",
          "Additional Details":
            "Please note Tenderers require their prices two or more days before the tender closing date; later submissions will not be considered.",
          Lat: -33.871312,
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Address:
            "458-466 George St & 49-51 Market St (Lot 1 DP1188148 & Lot 1 DP667918)",
          Suburb: "SYDNEY",
          State: "New South Wales",
          Stage: "DA Pending",
          Category: "HOSPITALITY",
          ...
          Notes: "CONCEPT DEVELOPMENT APPLICATION SUBMITTED",
          "Additional Details":
            "Development Application Number D/2019/882. Construction timeframe is a research estimate only & subject to council approvals & other factors. Lot 1 DP937618 & Lot 1 DP74913.",
          Lat: -33.871172,
          Long: 151.207231
        },
        color: "#E9DF00"
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Proposed alterations & additions to the existing commercial building. A new street facade including a new awning of the same height & extent as the existing awning. An additional level (425sq m) to the existing building which is setback from the front facade by 4m & includes a terrace in the setback area & a plant screen enclosure above.",
          Notes: "DEVELOPMENT APPLICATION SUBMITTED",
          "Additional Details":
            "Development Application Number D/2019/927. Construction timeframe is a research estimate only & subject to council approvals & other factors.",
          Lat: -33.86906,
          Long: 151.206326
        },
        color: "#E9DF00"
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Address:
            "345-355 George St (Lot 1 DP1006536, Lots 1 & 2 DP1010007 & Lots 1-7 SP62101)",
          Suburb: "SYDNEY",
          State: "New South Wales",
          Stage: "DA Pending",
          Category: "COMMERCIAL PREMISES",
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Proposed alterations & additions to Level 7 rooftop bar at the existing Primus Hotel Sydney. Partial demolition & extension of the existing awning & refurbishment of the existing bar unit, seating & plants.",
          Notes: "DEVELOPMENT APPLICATION SUBMITTED",
          "Additional Details":
            "Development Application Number D/2019/918. Construction timeframe is a research estimate only & subject to council approvals & other factors.",
          Lat: -33.874883,
          Long: 151.207605
        },
        color: "#E9DF00"
    ...
    },
    {
      ...
      properties: {
        ...
        project: {
          ...
          Ownership: "PRIVATE",
          Description:
            "Proposed internal fitout of the existing restaurant for use as development training facility, seminars & conference centre accommodating up to 160 attendees.",
          Notes: "DEVELOPMENT APPLICATION SUBMITTED",
          "Additional Details":
            "Development Application Number D/2019/1009. Construction timeframe is a research estimate only & subject to council approvals & other factors.",
          Lat: -33.870495,
          Long: 151.205863
        },
        color: "#E9DF00"
